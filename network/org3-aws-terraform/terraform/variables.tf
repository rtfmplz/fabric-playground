...
variable "resources_path" {
  type = "map"
  default = {
    private-user-data       = "./resources/init.sh"
    private-docker-compose  = "./resources/docker-compose.yaml"
    public-user-data       = "./resources/init.sh"
    public-docker-compose  = "./resources/docker-compose.yaml"
  }
}
